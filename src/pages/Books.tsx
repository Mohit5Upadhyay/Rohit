...
const LoadingSkeleton = () => (
  <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
    {[...Array(8)].map((_, i) => (
      <div key={i} className="animate-pulse bg-white/10 rounded-xl overflow-hidden">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {displayedBooks.map((book) => (
              <div key={book.id} className="group">
                <div className="bg-white/5 backdrop-blur-sm rounded-xl shadow-xl overflow-hidden
                  ...
                  <div className="p-6 space-y-4">
                    <h2 className="text-xl font-bold text-white group-hover:text-gold 
                                 transition-colors duration-200">
                      {book.title}
                    </h2>
                    <p className="text-gray-400">{book.author}</p>
                    <p className="text-gray-400 line-clamp-2">{book.description}</p>
                    
                    {book.awards && book.awards.length > 0 && (
                      <div>
                        <h3 className="text-sm font-bold text-gold mb-2">Awards:</h3>
                        <div className="flex flex-wrap gap-2">
